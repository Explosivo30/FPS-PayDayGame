...
root=pathlib.Path("D:/Unity/FPS-PayDayGame/Artifacts/MeleeRobot")
...
strip=editor.sequences.new_image("Melee robot",str(frames[0]),channel=1,frame_start=1)
...
if info["audioPeak"]>.0001:editor.sequences.new_sound("Game audio",str(root/"melee-audio.wav"),channel=2,frame_start=1)
